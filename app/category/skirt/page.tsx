...
export default function SkirtPage() {
  const products = Array.from({ length: 20 }, (_, i) => ({
    ...
    name: 'Zone Skirt',
    price: 34.95 + (i % 8) * 3,
    oldPrice: i % 3 === 0 ? 79.95 : null,
    badge: i % 5 === 0 ? 'Hot' : i % 6 === 0 ? '-30%' : null,
    image: `https://via.placeholder.com/400x500/cbd5e1/6b7280?text=Skirt+${i + 1}`,
  }));
      ...
      <div className="bg-green-50 py-4 border-b border-green-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/category/skirt" className="px-6 py-2.5 bg-green-500 text-white rounded-full font-medium shadow-md">
              Skirt
            </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div className="bg-gray-100 rounded-3xl overflow-hidden shadow-2xl">
              <img
                src="https://via.placeholder.com/600x800/6b7280/ffffff?text=Black+Skirt"
                alt="Black Skirt"
            ...
            <div className="bg-gray-200 rounded-3xl overflow-hidden shadow-2xl">
              <img
                src="https://via.placeholder.com/600x800/cbd5e1/6b7280?text=Light+Skirt"
                alt="Light Skirt"
                className="w-full object-cover"
              />
            </div>
