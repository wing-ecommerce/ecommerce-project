...
//     icon: Package,
//     subMenu: [
//       { href: "/admin/products", label: "List Products" },
...
//   // Only Dashboard should have background
...
//                   <button
//                     onClick={() => toggleMenu(item.href)}
//                     className={`w-full flex items-center justify-between px-6 py-3 rounded-lg text-gray-700`}
//                   >
//                     <div className="flex items-center gap-4">
//                       <Icon className="w-5 h-5" />
//                       {item.label}
...
//                   item.href === "/admin" && isDashboardActive
//                     ? "bg-green-600 text-white font-medium"
//                     : "text-gray-700"
//                 }`}
//               >
...
//         <Link
//           href="/signup"
//           className="flex items-center gap-4 px-6 py-3 bg-red-600 text-white rounded-lg font-medium"
//         >
//           <UserPlus className="w-5 h-5" />
//           <span>Sign Up</span>
//         </Link>
...
//         <Link
//           href="/"
//           className="flex items-center gap-4 px-6 py-3 text-gray-700 rounded-lg"
//         >
//           <ExternalLink className="w-5 h-5" />
//           <span>Go to Website</span>
//         </Link>
